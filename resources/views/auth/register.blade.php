            ...
            <div class="card">
                 <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="citizen_card" class="col-md-4 col-form-label text-md-end">{{ __('Citizen card') }}</label>

                            <div class="col-md-6">
                                <input id="citizen_card" type="text" class="form-control @error('citizen_card') is-invalid @enderror" name="citizen_card" value="{{ old('citizen_card') }}" required autocomplete="citizen_card" autofocus>
